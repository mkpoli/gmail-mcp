...
[![tests](https://img.shields.io/badge/tests-142_passing-success?logo=bun&logoColor=white)](#how-it-was-tested)
...
142 unit tests cover message construction (MIME nesting, RFC 2047 folding, RFC 2231 filenames, CR/LF rejection, base64 wrapping), body extraction across charsets, reply and forward composition, the Google token flows, the sign-in allowlist, and the CSRF and state-binding checks that guard the browser side of sign-in.
