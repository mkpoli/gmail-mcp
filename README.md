...
[![tests](https://img.shields.io/badge/tests-87_passing-success?logo=bun&logoColor=white)](#how-it-was-tested)
...
87 unit tests cover message construction (MIME nesting, RFC 2047 folding, RFC 2231 filenames, CR/LF rejection, base64 wrapping), body extraction across charsets, reply and forward composition, the Google token flows, and the sign-in allowlist.
